...
<div class="max-w-lg w-full bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden text-center p-8">
    <div class="mb-6 flex justify-center">
        <div class="w-24 h-24 bg-red-100 dark:bg-red-900/30 rounded-full flex items-center justify-center animate-pulse">
            <span class="text-4xl font-bold text-red-600 dark:text-red-400">500</span>
        </div>
    </div>
    
    <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-4">Internal Server Error</h2>
    
    <p class="text-gray-600 dark:text-gray-300 mb-8">
        Üzgünüz, sunucu tarafında beklenmeyen bir hata oluştu. Teknik ekibimiz durumdan haberdar edildi. Lütfen daha sonra tekrar deneyiniz.
    </p>
