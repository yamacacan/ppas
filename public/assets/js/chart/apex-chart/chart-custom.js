...
//column chart
var activityStatus=$('#column-chart').attr('data');
var parsedData = JSON.parse(activityStatus);
...
var columnChart1 = {
    ...
    series: seriesData,
    xaxis: {
        categories: ['Etkin','Kısmen Etkin','Etkin  Değil'],
    },
    // yaxis: {
    //     title: {
    //         text: '$ (thousands)'
    ...
    yaxis: {
        ...
        labels: {
          formatter: function(val) {
            // This formatter will round the value to the nearest whole number
...
//column chart2
var entityGroupLevel=$('#column-chart2').attr('data');
var parsedData = JSON.parse(entityGroupLevel);

//Gelen dataları ayrı birer diziye aktarıyoruz
var categoriesData = parsedData.map(item => item.entityGroup);
var seriesData = parsedData.map(item => item.data);
...
var columnChart2 = {
    ...
    series: [{
        name: 'Varlık Grubu Kritiklik Dereceleri',
        data: seriesData
    }],
    xaxis: {
...
//column chart 3
var findingLevel=$('#column-chart3').attr('data');
var parsedData = JSON.parse(findingLevel);
...
var columnChart3 = {
    ...
    series: seriesData,
    xaxis: {
        categories: ['Çok Yüksek','Yüksek','Orta','Düşük'],
    },
    // yaxis: {
    //     title: {
    //         text: '$ (thousands)'
...
//console.log($('#piechart').attr('data'));
//console.log($('#piechart').attr('data'));

var data=$('#piechart').attr('data');
...
var piechart = {
    ...
    labels: ['Seviye 1','Seviye  2','Seviye 3'],
    series: parsedData,
    responsive: [{
        breakpoint: 480,
        options: {
...
var piechart2 = {
    ...
    labels: ['Uygulandı '+parsedData[0],'Kısmen Uygulandı '+parsedData[1],'Uygulanmadı '+parsedData[2]],
    series: parsedData,
    responsive: [{
        breakpoint: 480,
        options: {
...
var radarData=$('#radarchart').attr('data');
var parsedData = JSON.parse(radarData);

//Gelen dataları ayrı birer diziye aktarıyoruz
var labelData = parsedData.map(item => item.label);
var seriesData = parsedData.map(item => item.data);
